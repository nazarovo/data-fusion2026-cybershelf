...
10.02.2026 
Метрика задачи позволяет переформулировать задачу из multi-label классификации и получить более мелкие задачи multi-label классификации, вплоть до 41 задачи одноклассовой классификации.
