...
---------------------------
Нужно учить отдельную модель на каждый класс? 
Это нерационально. Если многометочная модель дает по классу скор 0.99, то выигрыш от отдельно модели по классу не превысит (1-0.99)/41. (Скор по классу можно вычислить занулив в саммите другие классы) В качестве параметров модели можно указывать предикты мультимодели. (Если помнить про переобучение)
